...
export class Settings implements OnInit, OnDestroy {
  // THE "AI MODEL" PICKER, ITS PROVIDER LISTS AND THE SETUP WIZARD ARE GONE (P2, plan 6.5). The
  // picker governed nothing a run read once routing existed (LEDGER #204); every model call now
  // goes through the selected Crucible server on the routing table's choice, and keys live on
  // that server (the Crucible Servers card below, #194).
