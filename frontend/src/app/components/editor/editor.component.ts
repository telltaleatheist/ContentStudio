...
export class EditorComponent implements OnInit, AfterViewInit, OnDestroy {
  ...
  /**
   * True while File ▸ Relink… is open. A flag rather than an entry object like `setupEntry`,
  ...
  /** File ▸ Relink…: close the menu and open the asset-relinking dialog. */
  onRelinkFromMenu(): void {
    this.menuOpen = false;
